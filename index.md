...
<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <section class="py-12 border-t">
    <h2 class="text-3xl font-bold mb-8">Project Demos & Performances</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden p-6">
        ...
        <a href="{{ '/about/' | relative_url }}" class="inline-block text-blue-600 hover:text-blue-800 font-medium">Learn more about my background →</a>
      </div>
    </div>
  </section>
