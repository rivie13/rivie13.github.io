...
<div class="max-w-4xl mx-auto">
  ...
  <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg mb-8 shadow-sm">
  ...
  <div class="bg-white rounded-lg shadow-md p-6 mb-8">
    ...
    <div class="flex flex-col md:flex-row gap-6 items-center">
      <div class="md:w-1/2">
        <img src="{{ '/assets/images/philadelphia-philly.gif' | relative_url }}" alt="Philadelphia" class="rounded-lg shadow-md w-full">
      </div>
      <div class="md:w-1/2">
  ...
  <div class="flex justify-center space-x-4">
    <a href="{{ '/services/' | relative_url }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg transition-all">
      Services
    </a>
    <a href="{{ '/contact/' | relative_url }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg transition-all">
      Get in Touch
    </a>
  </div>
</div> 